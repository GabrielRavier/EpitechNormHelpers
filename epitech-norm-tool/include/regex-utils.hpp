...
#include <boost/regex/v4/match_flags.hpp>	// for boost::regex_flag_type
...
void match_all_occurences_of_regex_in_files(const git::index::file_list &filenames, std::string_view description_of_what_you_re_looking_for, int level, const boost::regex& regex, boost::regex_constants::match_flags regex_flags = boost::regex_constants::match_flags::match_default);
